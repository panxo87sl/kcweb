              ...
              <div className="osteoSpecialistBlock__content">
                <div className="osteoSpecialistBlock__content_cv">
                  ...
                  <ul className="osteoSpecialistBlock__list">
                    ...
                    <li>
                      <strong>Osteópata C.O.</strong>, Escuela de Osteopatía de Madrid
                      (formación oficial 5 años).
                    </li>
                    <li>
                      <strong>Máster en Osteopatía</strong>, Universidad Pontificia de
                      Salamanca (España).
                    </li>
                    <li>
                      <strong>En formación</strong> como Psiconeuroinmunólogo Clínico, PNI
                      Europe (formación oficial 3 años, Buenos Aires).
                    </li>
                    <li>
        ...
        <section className="osteoSection osteoSection--soft">
          <div className="osteoSection__inner osteoSection__inner--center">
            ...
            <p className="osteoText">
              ...
              disfunciones del
              <strong> sistema músculo-esquelético</strong> (articulaciones, músculos y
              tejidos), buscando <strong>restaurar la función del cuerpo</strong>. Se basa en
              la relación entre
              <strong> estructura y función</strong>: cuando existen{" "}
              <strong>restricciones de movilidad</strong>, el organismo compensa, puede
              ...
              <article className="osteoCard">
                ...
                <div className="osteoCard__body">
                  ...
                  <p className="osteoText">
                    ...
                    generar debido a sobrecargas, movimientos bruscos, etc. Se llama punción
                    seca porque no introducimos ningún anestésico ni sustancia, liberando así
                    la tensión miofascial del segmento.
                  </p>
                </div>
              </article>
              ...
              <article className="osteoCard">
                ...
                <div className="osteoCard__body">
                  ...
                  <ul className="osteoList osteoList--compact">
                    ...
                    <li>
                      Mejorar la funcion neuromuscular, los patrones de reclutamiento muscular
                      y el control motor.
                    </li>
                  </ul>
                </div>
              ...
              <article className="osteoCard">
                ...
                <div className="osteoCard__body">
                  ...
                  <p className="osteoText">
                    ...
                    recuperación física. Su tecnología de percusión alcanza mayor profundidad
                    en el tejido muscular, estimulando la circulación y ayudando a liberar la
