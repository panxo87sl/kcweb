...
export default function EsteticaPage() {
  return (
    <>
      <Helmet>
        <title>Clínica Estética en Antofagasta | KINECLIN</title>
        <meta
          name="description"
          content="Clínica estética en Antofagasta con Carolina Llave, Kinesióloga especialista en tratamientos faciales y corporales. Atención personalizada en KINECLIN."
        />
        {/* La sección "Tratamientos que se realizan" aún tiene contenido de relleno
            (Lorem Ipsum) mientras se termina esta página: no debe indexarse todavía. */}
